    ...
    protected function describeApplication(Application $application, array $options = array())
    {
        ...
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            if ($describedNamespace) {
                $this->writeText(sprintf('<comment>Available installer for the "%s" namespace:</comment>', $describedNamespace), $options);
            } else {
                $this->writeText('<comment>Available installer:</comment>', $options);
            }

            // add installer by namespace
            foreach ($description->getNamespaces() as $namespace) {
                ...
                foreach ($namespace['installer'] as $name) {
                    $this->writeText("\n");
