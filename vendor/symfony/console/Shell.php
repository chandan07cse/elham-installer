...
<info>Running with process isolation, you should consider this:</info>
  ...
  * installer don't support interactivity, all params must be passed explicitly,
  * installer output is not colorized.
...
or <comment>list</comment> to get a list of available installer.
