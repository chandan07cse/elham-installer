...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(array('help', 'list'), array_keys($application->all()), '__construct() registered the help and list installer by default');
    }
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('Symfony\\Component\\Console\\Command\\HelpCommand', $commands['help'], '->all() returns the registered installer');
    ...
    public function testAdd()
    {
        ...
        $commands = $application->all();
        $this->assertEquals(array($foo, $foo1), array($commands['foo:bar'], $commands['foo:bar1']), '->addCommands() registers an array of installer');
    }
    ...
    public function testFindNamespaceWithSubnamespaces()
    {
        ...
        $this->assertEquals('foo', $application->findNamespace('foo'), '->findNamespace() returns installer even if the installer are only contained in subnamespaces');
    }
    ...
    /**
     * @expectedException        Symfony\Component\Console\Exception\CommandNotFoundException
     * @expectedExceptionMessage There are no installer defined in the "bar" namespace.
     */
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertSame(array(), $e->getAlternatives());
            $this->assertEquals('There are no installer defined in the "Unknown-namespace" namespace.', $e->getMessage(), '->find() throws a CommandNotFoundException if namespace does not exist, without alternatives');
        }
        ...
        try {
            ...
            $this->assertRegExp('/There are no installer defined in the "foo2" namespace./', $e->getMessage(), '->find() throws a CommandNotFoundException if namespace does not exist, with alternative');
